      ...
      <div className="programs-list">
        {programsData.map((program, index) => (
          <div className="program-category" key={index}>
            <span className="programs-category-icon">{program.img}</span>
            <span className="programs-category-header">{program.header}</span>
            <span className="programs-category-details">{program.details}</span>
            <div className="get-info">
              <span>Get Info</span>
              <FontAwesomeIcon
                icon={faRightLong}
                className="get-info-right-arrow"
              />
            </div>
          </div>
        ))}
